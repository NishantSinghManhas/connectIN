...
Socket.IO for live updates (chat/notifications and owner impression updates)
...
Uploads failing (Cloudinary)

Verify CLOUDINARY_* environment variables and file type support on your Cloudinary plan.

Socket not connecting

Ensure server is running on http://localhost:5000

and the client has a valid JWT token.

Impressions not updating live

Restart the server after changes; the owner receives post_impression_updated via Socket.IO.
